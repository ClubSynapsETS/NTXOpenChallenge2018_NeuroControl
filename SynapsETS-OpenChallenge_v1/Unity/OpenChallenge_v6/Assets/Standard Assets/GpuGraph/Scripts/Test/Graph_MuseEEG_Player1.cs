...
public class Graph_MuseEEG_Player1: MonoBehaviour{    private int Count;    private Rect GraphRect;    public float EEG_value = 0;
    ...
    void Start()    {        Count = 0;    }        // Update is called once per frame    void Update()    {        Count++;        float xSize = 0.3f * Screen.width;        float ySize = 0.1f * Screen.height;        float xPos = 0.2f * Screen.width;        float yPos = 0.1f * Screen.height;        GraphRect = new Rect(xPos, yPos, xSize, ySize);
        ...
        if (GraphManager_MuseEEG_Player1.Graph != null)        {
            ...
            GraphManager_MuseEEG_Player1.Graph.Plot("Test_ScreenSpace", EEG_value, Color.green, GraphRect);        }    }}