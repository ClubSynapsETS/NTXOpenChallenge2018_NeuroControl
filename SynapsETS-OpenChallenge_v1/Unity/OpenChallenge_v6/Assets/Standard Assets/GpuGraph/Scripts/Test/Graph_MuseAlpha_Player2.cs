...
public class Graph_MuseAlpha_Player2: MonoBehaviour{    private int Count;    private Rect GraphRect;
    ...
    void Start()    {        Count = 0;    }        // Update is called once per frame    void Update()    {        Count++;        float xSize = 0.3f * Screen.width;        float ySize = 0.1f * Screen.height;        float xPos = 0.675f * Screen.width;        float yPos = 0.3f * Screen.height;        GraphRect = new Rect(xPos, yPos, xSize, ySize);
        ...
        if (GraphManager_MuseAlpha_Player2.Graph != null)        {
            ...
            GraphManager_MuseAlpha_Player2.Graph.Plot("Test_ScreenSpace", EEG_value, Color.green, GraphRect);        }    }}