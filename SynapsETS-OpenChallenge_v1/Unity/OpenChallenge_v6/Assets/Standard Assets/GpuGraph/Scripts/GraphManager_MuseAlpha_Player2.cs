...
public class GraphManager_MuseAlpha_Player2 : MonoBehaviour 
{

    // MODIFIED:
    private static string customUIname = "_MuseAlpha_Player2";
        ...
        public void InitializeParentUI()
        {
            ...
            {				
				...
				if(GraphManagerUI)
				{
					...
					{
						if (string.Equals(transform.gameObject.name, customUIname+"Graphs_UI"))
						{
        ...
        public void UpdateUI()
        {
            ...
            if (ParentUI)
            {
                if (CanvasUI == null)
                {
                    ...
                    string canvasObjectName = string.Format("{0}_Canvas_{1}", IsWorldSpace ? customUIname+"WS" : customUIname+"SS", Name);
    ...
    static GameObject CreateGlobalObjects()
    {
        ...
        {
            GraphManagerUI = GameObject.Find(customUIname+"GraphManager_UI");

            if (GraphManagerUI == null)
            {
                GraphManagerUI = new GameObject();
                GraphManagerUI.transform.position = new Vector3(0, 0, 0);
                GraphManagerUI.name = customUIname+"GraphManager_UI";
            }
		}

		if (GraphManagerUI && GraphsUI == null)
		{
			GraphsUI = GameObject.Find(customUIname+"Graphs_UI");
			...
			if (GraphsUI == null)
			{
				...
				GraphsUI.name = customUIname+"Graphs_UI";
			}
		}
    ...
    void Start()
    {
        ...
        if (!m_GraphMaterial)
        {
            m_GraphMaterial = new Material(Shader.Find("Hidden/GPUGraph"));
